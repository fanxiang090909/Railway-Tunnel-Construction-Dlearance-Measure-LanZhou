...
C:\Qt2\4.8.0\include\QtNetwork（Qt网络传输Socket编程）
C:\Qt2\4.8.0\include\QtGui（Qt界面）
C:\Qt2\4.8.0\include\QtSql（Qt数据库驱动及访问类库）
C:\Qt2\4.8.0\include\QtWebKit (Qt嵌入WebKit浏览器访问库)
